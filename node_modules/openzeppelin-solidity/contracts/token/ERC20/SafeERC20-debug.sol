...
library SafeERC20 {
  ...
  internal
  {
    ...
    require((value == 0) || (token.allowance(msg.sender, spender) == 0), "SafeERC20: Value specified invalid.");
    require(token.approve(spender, value), "SafeERC20: Approval unsuccessful");
  }
  ...
  internal
  {
    ...
    require(token.approve(spender, newAllowance), "SafeERC20: Approval unsuccessful.");
  }
